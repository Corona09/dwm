...
/*{{{*/
	{ MODKEY              , XK_e         , spawn          , SHCMD("sh ~/.dwm-action.sh e"  )         } ,
	{ MODKEY              , XK_r         , spawn          , SHCMD("sh ~/.dwm-action.sh r"  )         } ,
	{ MODKEY              , XK_z         , spawn          , SHCMD("sh ~/.dwm-action.sh z"  )         } ,
	{ MODKEY              , XK_x         , spawn          , SHCMD("sh ~/.dwm-action.sh x"  )         } ,
	{ MODKEY              , XK_c         , spawn          , SHCMD("sh ~/.dwm-action.sh c"  )         } ,
	{ MODKEY              , XK_p         , spawn          , SHCMD("sh ~/.dwm-action.sh p"  )         } ,
	{ MODKEY              , XK_n         , spawn          , SHCMD("sh ~/.dwm-action.sh n"  )         } ,
	{ MODKEY|ShiftMask    , XK_e         , spawn          , SHCMD("sh ~/.dwm-action.sh E"  )         } ,
	{ MODKEY|ShiftMask    , XK_r         , spawn          , SHCMD("sh ~/.dwm-action.sh R"  )         } ,
	{ MODKEY|ShiftMask    , XK_z         , spawn          , SHCMD("sh ~/.dwm-action.sh Z"  )         } ,
	{ MODKEY|ShiftMask    , XK_x         , spawn          , SHCMD("sh ~/.dwm-action.sh X"  )         } ,
	{ MODKEY|ShiftMask    , XK_c         , spawn          , SHCMD("sh ~/.dwm-action.sh C"  )         } ,
	{ MODKEY|ShiftMask    , XK_p         , spawn          , SHCMD("sh ~/.dwm-action.sh P"  )         } ,
	{ MODKEY|ShiftMask    , XK_n         , spawn          , SHCMD("sh ~/.dwm-action.sh N"  )         } ,
	{ MODKEY              , XK_F1        , spawn          , SHCMD("sh ~/.dwm-action.sh f1" )         } ,
	{ MODKEY              , XK_F1        , spawn          , SHCMD("sh ~/.dwm-action.sh f1" )         } ,
	{ MODKEY              , XK_F2        , spawn          , SHCMD("sh ~/.dwm-action.sh f2" )         } ,
	{ MODKEY              , XK_F3        , spawn          , SHCMD("sh ~/.dwm-action.sh f3" )         } ,
	{ MODKEY              , XK_F4        , spawn          , SHCMD("sh ~/.dwm-action.sh f4" )         } ,
	{ MODKEY              , XK_F5        , spawn          , SHCMD("sh ~/.dwm-action.sh f5" )         } ,
	{ MODKEY              , XK_F6        , spawn          , SHCMD("sh ~/.dwm-action.sh f6" )         } ,
	{ MODKEY              , XK_F7        , spawn          , SHCMD("sh ~/.dwm-action.sh f7" )         } ,
	{ MODKEY              , XK_F8        , spawn          , SHCMD("sh ~/.dwm-action.sh f8" )         } ,
	{ MODKEY              , XK_F9        , spawn          , SHCMD("sh ~/.dwm-action.sh f9" )         } ,
	{ MODKEY              , XK_F10       , spawn          , SHCMD("sh ~/.dwm-action.sh f10")         } ,
	{ MODKEY              , XK_F11       , spawn          , SHCMD("sh ~/.dwm-action.sh f11")         } ,
	{ MODKEY              , XK_F12       , spawn          , SHCMD("sh ~/.dwm-action.sh f12")         } ,
	{ MODKEY|ShiftMask    , XK_F1        , spawn          , SHCMD("sh ~/.dwm-action.sh F1" )         } ,
	{ MODKEY|ShiftMask    , XK_F1        , spawn          , SHCMD("sh ~/.dwm-action.sh F1" )         } ,
	{ MODKEY|ShiftMask    , XK_F2        , spawn          , SHCMD("sh ~/.dwm-action.sh F2" )         } ,
	{ MODKEY|ShiftMask    , XK_F3        , spawn          , SHCMD("sh ~/.dwm-action.sh F3" )         } ,
	{ MODKEY|ShiftMask    , XK_F4        , spawn          , SHCMD("sh ~/.dwm-action.sh F4" )         } ,
	{ MODKEY|ShiftMask    , XK_F5        , spawn          , SHCMD("sh ~/.dwm-action.sh F5" )         } ,
	{ MODKEY|ShiftMask    , XK_F6        , spawn          , SHCMD("sh ~/.dwm-action.sh F6" )         } ,
	{ MODKEY|ShiftMask    , XK_F7        , spawn          , SHCMD("sh ~/.dwm-action.sh F7" )         } ,
	{ MODKEY|ShiftMask    , XK_F8        , spawn          , SHCMD("sh ~/.dwm-action.sh F8" )         } ,
	{ MODKEY|ShiftMask    , XK_F9        , spawn          , SHCMD("sh ~/.dwm-action.sh F9" )         } ,
	{ MODKEY|ShiftMask    , XK_F10       , spawn          , SHCMD("sh ~/.dwm-action.sh F10")         } ,
	{ MODKEY|ShiftMask    , XK_F11       , spawn          , SHCMD("sh ~/.dwm-action.sh F11")         } ,
	{ MODKEY|ShiftMask    , XK_F12       , spawn          , SHCMD("sh ~/.dwm-action.sh F12")         } ,
/*}}}*/
